...
import com.guicai.model.DataModel;
...
public class MainGenerator {
    ...
    public static void doGenerate(DataModel model) throws TemplateException, IOException {
        ...
        inputPath = new File(inputRootPath, "src/com/guicai/acm/MainTemplate.java.ftl").getAbsolutePath();
        outputPath = new File(outputRootPath, "src/com/guicai/acm/MainTemplate.java").getAbsolutePath();
