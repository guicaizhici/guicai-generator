...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String originProjectPath = new File(projectPath).getParent() + File.separator + "guicai-generator-demo-project/acm-template";
        ...
        String fileInputPath = "src/com/guicai/acm/MainTemplate.java";
